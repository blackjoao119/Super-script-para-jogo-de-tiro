...
--// =============================================
--// 🔥 SISTEMA DE TELEPORTE – ORDEM CORRIGIDA
--// =============================================
...
-- Layout que respeita LayoutOrder
local layout = Instance.new("UIListLayout", container)
layout.Padding = UDim.new(0, 8)
layout.HorizontalAlignment = Enum.HorizontalAlignment.Center
layout.SortOrder = Enum.SortOrder.LayoutOrder  -- <-- corrigido
...
local function refreshContainer()
    -- Remove todos os elementos visuais antigos
    for _, child in ipairs(container:GetChildren()) do
        child:Destroy()
    end

    -- 1. Locais Fixos (dourados, sem deletar)
    for i, loc in ipairs(FixedLocations) do
        ...
        btn.TextColor3 = Color3.fromRGB(30, 30, 30)         -- texto escuro
        btn.Font = Enum.Font.GothamBold
        btn.TextSize = 14
        btn.LayoutOrder = i  -- 1 e 2
        btn.AutoButtonColor = false
        Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 8)

        -- Hover dourado mais claro
    ...
    for i, loc in ipairs(savedLocations) do
        ...
        itemFrame.LayoutOrder = 100 + i  -- sempre depois dos fixos (101, 102...)
...
Rayfield:Notify({
    ...
    Content = "Teleporte ordenado: fixos no topo, delete individual!",
    Duration = 5,
    Image = 4483362458
})