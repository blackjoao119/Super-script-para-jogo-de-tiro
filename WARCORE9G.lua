...
--// =============================================
--// 🔥 SISTEMA DE TELEPORTE – VISUAL CORRIGIDO
--// =============================================
...
-- ========================
-- JANELA PRINCIPAL (CORES CORRIGIDAS)
-- ========================
local tpFrame = Instance.new("Frame", tpGui)
tpFrame.Size = UDim2.new(0, 360, 0, 540)
tpFrame.Position = UDim2.new(0.5, -180, 0.5, -270)
tpFrame.BackgroundColor3 = Color3.fromRGB(30, 33, 45)  -- fundo mais claro
tpFrame.BackgroundTransparency = 0.05  -- quase opaco, mas com leve transparência
...
titleBar.BackgroundColor3 = Color3.fromRGB(35, 38, 50)  -- tom mais claro
...
titleLabel.TextColor3 = Color3.fromRGB(240, 245, 255)  -- branco puro
...
posPanel.BackgroundColor3 = Color3.fromRGB(40, 43, 55)  -- fundo mais claro
...
local function refreshContainer()
    ...
    for i, loc in ipairs(savedLocations) do
        ...
        btn.BackgroundColor3 = Color3.fromRGB(50, 55, 70)  -- fundo mais claro
...
Rayfield:Notify({
    ...
    Content = "Janela de teleporte 100% visível e premium!",
    Duration = 5,
    Image = 4483362458
})