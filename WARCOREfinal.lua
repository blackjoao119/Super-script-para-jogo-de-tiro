...
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling -- importante para ordenação
...
--// =============================================
--// 🔥 CORREÇÕES: RAIO-X E LINHA DE MIRA
--// =============================================

-- 1. Linha de Mira (Frame)
...
LineFrame.BackgroundTransparency = 0.4  -- levemente transparente para melhor visualização
LineFrame.BorderSizePixel = 0
LineFrame.Visible = false
LineFrame.ZIndex = 30  -- bem alto para ficar acima de tudo
Instance.new("UICorner", LineFrame).CornerRadius = UDim.new(0, 1)

-- Função segura para obter DepthMode
    ...
    for _, p in ipairs(Players:GetPlayers()) do
        if p ~= Player and p.Character then
            ...
            if head then
                ...
                -- Define o Adornee explicitamente
                hl.Adornee = char
                -- DepthMode seguro
                pcall(function()
...
Rayfield:Notify({
    ...
    Content = "Raio-X e Linha de Mira corrigidos!",
    Duration = 5,
    Image = 4483362458
})