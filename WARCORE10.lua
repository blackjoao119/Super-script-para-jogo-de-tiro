...
--// =============================================
--// SISTEMA DE TELEPORTE (mantido exatamente igual)
--// =============================================
    ...
    for player, line in pairs(Lines) do
        if lineEnabled and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
            ...
            if onScreen and screenPos.Z > 0 then
                ...
                line.From = Vector2.new(Camera.ViewportSize.X / 2, Camera.ViewportSize.Y) -- centro inferior (ou centro total?)
...
RunService.RenderStepped:Connect(function(dt)
    ...
    -- Atualiza as linhas de mira (Drawing)
    updateLines()
...
Rayfield:Notify({
    ...
    Content = "Linha de Mira com Drawing 2D! Personalize cor e espessura.",
    Duration = 5,
    Image = 4483362458
})