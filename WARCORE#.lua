...
--// =============================================
--// 🔥 SISTEMA DE TELEPORTE – ORDEM CORRIGIDA (tpFrame ANTES do toggleMenu)
--// =============================================
...
-- ========================
-- 1. JANELA PRINCIPAL (criada antes de qualquer função que a utilize)
-- ========================
...
-- ========================
-- 2. FUNÇÕES QUE USAM tpFrame (definidas depois que tpFrame já existe)
-- ========================
...
-- ========================
-- 3. BOTÃO FLUTUANTE (criado antes do Toggle que o referencia)
-- ========================
...
-- ========================
-- 4. TOGGLE PRINCIPAL (agora TpFloatingBtn já existe)
-- ========================
...
Rayfield:Notify({
    ...
    Content = "Sistema de teleporte corrigido e funcional!",
    Duration = 5,
    Image = 4483362458
})