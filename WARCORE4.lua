...
--// =============================================
--// 🔄 NOVO MENU FLUTUANTE DE TELEPORTE (DESIGN PROFISSIONAL)
--// =============================================
...
tpFrame.BackgroundTransparency = 1  -- para fade, usaremos a transparência do fundo no tween
...
-- Arrumar cantos superiores apenas
...
-- Efeitos hover (simples com animação)
...
-- Arrastar o menu pela barra de título
...
-- Botão Limpar Tudo (abaixo do container)
...
local function refreshContainer()
    -- Remove todos os botões dentro do container
...
minimizeBtn.MouseButton1Click:Connect(function()
    toggleMenu(false)
    -- Atualiza o Toggle na Rayfield (precisa desativar)
    -- Vamos acessar o Toggle via uma variável que guardaremos
...
Rayfield:Notify({
    ...
    Content = "Menu flutuante de teleporte atualizado!",
    Duration = 5,
    Image = 4483362458
})