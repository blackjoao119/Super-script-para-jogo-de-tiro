...
--// =============================================
--// ABA: TELEPORTE (NOVA – ADICIONADA AGORA)
--// =============================================
local savedPositions = {}

TeleportTab:CreateSection("Salvar Posições")
...
TeleportTab:CreateButton({
    ...
    Callback = function()
        ...
        if char and char:FindFirstChild("HumanoidRootPart") then
            ...
            Rayfield:Notify({
                Title = "Posição Salva",
                Content = "Slot " .. #savedPositions .. " | X:" .. math.floor(pos.X) .. " Y:" .. math.floor(pos.Y) .. " Z:" .. math.floor(pos.Z),
                Duration = 3,
                Image = 4483362458
            })
        end
...
TeleportTab:CreateButton({
    Name = "🚀 Teleportar para Última Posição Salva",
    Callback = function()
        local char = Player.Character
        if char and char:FindFirstChild("HumanoidRootPart") and #savedPositions > 0 then
            local target = savedPositions[#savedPositions]
            char.HumanoidRootPart.CFrame = CFrame.new(target)
            Rayfield:Notify({
                Title = "Teleporte",
                Content = "Movido para slot " .. #savedPositions,
                Duration = 3,
                Image = 4483362458
            })
        else
...
Rayfield:Notify({
    ...
    Content = "Aba 'Teleporte' adicionada com sucesso!",
    Duration = 5,
    Image = 4483362458
})