...
-- Função para animar botão flutuante (definida antes do Toggle para ser usada no callback)
...
-- Função toggleMenu (definida antes do botão para ser usada nos eventos)
...
-- ========================
-- BOTÃO FLUTUANTE (CRIADO ANTES DO TOGGLE)
-- ========================
...
-- Eventos de arraste e clique do botão flutuante
...
-- Clique alterna abertura/fechamento da janela
...
-- Botões da janela (minimizar e fechar)
...
-- ========================
-- TOGGLE PRINCIPAL (agora enxerga TpFloatingBtn)
-- ========================
...
Rayfield:Notify({
    ...
    Content = "Sistema de teleporte 100% corrigido e funcional!",
    Duration = 5,
    Image = 4483362458
})